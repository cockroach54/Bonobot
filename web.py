...
db = client.eliza
collection = db.experiment  # dialogs: pilot collection, experiment: real data
...
@app.route('/admin')
def admin():
  print('admin page called...', file=sys.stdout)
...
if __name__ == '__main__':
    ...
    socketio.run(app, debug=True, host='10.0.1.21', port=5000)      
